...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container1"style="width:946px;margin-left:344px;">
          <div class="word-box">
             <div class="word-text">
                <span><span class="auto-style2">Wallet&nbsp;</span> &nbsp;&nbsp; &nbsp; <br /><b>0.0</b></span>           
              ...
              <span><span class="auto-style2">Total Reffered&nbsp;</span> &nbsp;<br />
               ...
               <span><span class="auto-style2">Total Earning</span> &nbsp; &nbsp;<br /></span>                   
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="bidding-widget margin-bottom-30">
                                        ...
                                        <div class="bidding-value"> First Subscription <i class="fa-light fa-circle-question" style="color:#72767e;" data-tippy-placement="top" data-tippy="" data-original-title="You will get a commission on the first successful subscription payment."></i>
                                      </div>
                                ...
                                <div class="col-md-6"style="margin-right:441px;">
                                    ...
                                    <div class="d-flex">
                                        <input type="text" value="http://hype.sociusus.com/?ref=eqosw6437a11d38642" id="myInput"style="width:323px;height:37px;"/>
                                          <button onclick="myFunction1()"style="width:40px;height:37px;background:#0094ff;"><i class="fa fa-copy"></i></button>                                       
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="dashboard-box margin-top-0 margin-bottom-30"style="margin-top:4px;margin-left:361px;width:918px;">
                    <!-- Headline -->
                    <div class="headline">
                        <h3><i class="fa-sharp fa-light fa-money-bill" style="color: #72a0ee;"></i>Commissions</h3>
                    </div>
