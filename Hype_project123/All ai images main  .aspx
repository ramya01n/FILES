...
<div class="topbar"style="margin-top:-11px;position:fixed;">
 ...
 <%-- ai images box part --%>  
 <!-- Headline -->
                    <div class="headline"style="margin-left:340px;">
                        <h3><i class="fa fa-file-text"></i>All Images</h3>
                    </div>
                    <div class="content with-padding"style="margin-left:334px;">
                        <table class="basic-table">
                            ...
                            <tbody>
                             <tr class="no-order-found">
                                <td colspan="4" class="auto-style1"style="margin-left:1px;">No images found</td>
                            </tr>
                             </tbody>
                        </table>
                     </div>
