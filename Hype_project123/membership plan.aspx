<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="membership plan.aspx.cs" Inherits="Hype_project123.membership_plan" %>
                ...
                <div class="innersection">
                    ...
                    <ul>
                        ...
                        <li><i class="fa-regular fa-circle-check" style="color: #5af207;"></i>Free Support</li>
                         <li>
                             <button class="button" onclick="window.location.href='Upgrade membership.aspx'" type="button">
                                Upgarde plan
                             </button>
                        </li>
                    </ul>
