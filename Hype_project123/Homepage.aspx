  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
    ...
    background-color: #fff;
      ...
      *{
        ...
        body, h1, h2, h3, h4, h5, h6, input[type=text], input[type=password], input[type=email], textarea, select, input[type=button], input[type=submit], button, body .pac-container ,span{
...
.Testimonails{
 ...
 .radio{
    ...
    <!-- Brain logo -->
    <div id="wrapper" class="" style="padding-top: 76px;"> 
       <img src="images/brainsimage.png" style="width:12%; margin-left: 590px;" />
         <div class="animated_rainbow_2" style="margin-left: 25px/; text-align: center;">
        ...
        <center>
            <div>
              ...
              <div class="form-group" style="margin-top: 32px;">
                <a href="Registrationpage.aspx" class="button ripple-effect button-sliding-icon" style="width: -47.906px;">Get Started For Free<i class="icon-feather-arrow-right" style="color:wheat;"></i></a>
              </div>
          </center>
           <center>
    ...
    <!-- How its work part -->
            ...
            <div class="container">
                <div class="row" style="display: flex">
                    <div class="col-md-4">
                        <center>
                            ...
                            <p class="text-justify">
                                Choose a content creation template.<br/> Multiple templates are available for <br/>your all needs.
                            </p>
                        </center>
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <center>
                            <img src="images/filltheformimage.png" style="height: 132px; margin-top: 5px; width: 170px;" />
                            <h2>Fill the form</h2>
                        <p class="text-justify">
                            Enter a detailed description of your content.<br/> Tell the AI what do you <br/>want
                        </p>
                        <h2>&nbsp;</h2>
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <p class="text-justify">
                            Get a unique high quality content. <br/>The content is plagiarism free and <br/>you can use it anywhere.
                        </p>
                        <center>
                    </div>
                </div>
        ...
        <div class="section padding-top-65 padding-bottom-65" style="margin-top:66px;">
            <div class="container margin-bottom-20">
                <div class="section-headline centered margin-top-0 margin-bottom-30">
                    <h3 class="margin-bottom-5" >Templates</h3>
                    <p class="paragraph">Generate your required content with over 60+ content creation templates</p>
                </div>
        ...
        <div class="row ai-template-blocks" style="margin-left: 122px; margin: 132px;color:#000000;">
            ...
            <div class="section">
                <div class="section1" style="margin-left: 445px;">
                    ...
                    <div class="radio" style="margin-left: -1px;">
                        ...
                        <input type="radio" name="radio-buttons" value="monthly" class="big-radio" onchange="enableInputField(5)" />
                        Monthly
                        <input type="radio" name="radio-buttons" value="yearly"class="big-radio" onchange="enableInputField(50)" />
                        Yearly
                        <input type="radio" name="radio-buttons" value="Lifetime"class="big-radio" onchange="enableInputField(550)" />
                        Life Time
                    <br/>
                    <br />
                        <button class="auto-style7" name="upgrade1"  type="submit" value="1">
                            Recommended
                        </button>
                    </div>
                </div>
            ...
            <div class="auto-style8">
                <div class="innersection">
                    <ul>
                        ...
                        <li>
                            <button style="width: 192px; height: 41px;"><h1>Free</h1></button>
                        ...
                        <li>
                            <button class="btn btn-primary" style="width: 200px; height: 43px;">Current Plan</button>
                    </ul>
                </div>
                <div class="innersection">
                    <ul>
                        ...
                        <li>
                           <button style="width: 192px; height: 41px;"><h1>Trail</h1></button>
                        <li>Features of Free Plan</li>
                        <li><b>32</b> AI Document Templates</li>
                        <li><b>10,000</b> Words per month</li>
                        <li><b>100</b> Images per month</li>
                        ...
                        <li><i class="fa-regular fa-circle-xmark" style="color: #ff0000;"></i>Free Support</li>
                        <li>
                             <button class="btn btn-primary" style="width: 200px; height: 43px;">Upgrade</button>
                    </ul>
                </div>
                <div class="innersection">
                    <ul>
                        <li><strong>Extended Plan</strong></li>                     
                        <li> <input id="input-field" disabled="disabled" style="width: 151px; height: 41px;" type="text"></li>
                        <li>Features of Free Plan</li>
                        <li><b>32</b> AI Document Templates</li>
                        <li><b>10,000</b> Words per month</li>
                        <li><b>100</b> Images per month</li>
                        ...
                        <li>
                        <button class="btn btn-primary" style="width: 200px; height:43px;"><a href="Upgrade membership 1.aspx">Upgrade</a></button></li>
                    </ul>
                </div>
            </div>
        </div>--%>
    ...
    <div class="section-headline centered margin-top-0 margin-bottom-5">
        <h3 class="Testimonails">Testimonials</h3>
...
<%-- blogs --%>
            ...
            <div class="row">
                <div class="col-xl-12">
                    ...
                    <div class="section-headline margin-top-0 margin-bottom-45">
                       <h3 class="headings">Recent Blog</h3>  
                        <a href="Recentblog1.aspx" class="headline-link">View Blog<i class="fa-solid fa-arrow-right" style="color: #1524c7;"></i></a>
                    </div>

                    <div class="row">
                        <!-- Blog Post Item -->
                              <div class="col-xl-4">
                                <a href="https://localhost:44322/firstblog1.aspx" class="blog-compact-item-container">
      ...
      <div class="slideshow-container" style="margin: 128px; top: 70px;">
        <div class="mySlides fade">
            <img src="images/logo-carousel-04.png" style="margin-left: 384px;">
        </div>

        <div class="mySlides fade">
          
            <img src="images/logo-carousel-01.png"style="margin-left: 384px;" />
        </div>

        <div class="mySlides fade">
         
            <img src="images/logo-carousel-02.png" style="margin-left: 384px;" />
        </div>

        <div class="mySlides fade">
            <img src="images/logo-carousel-03.png" style="margin-left: 384px;" />
        </div>
        ...
        <div class="mySlides fade">
            <img src="images/logo-carousel-05.png" style="margin-left: 384px;" />
        </div>
        <div class="mySlides fade">
            <img src="images/logo-carousel-06.png" style="margin-left: 384px;" />
        </div>
