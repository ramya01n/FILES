<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Currentplan.aspx.cs" Inherits="Hype_project123.Currentplan" %>
...
<div class="topbar"style="margin-top:-11px;position:fixed;">
    ...
    <div class="dashboard-headline" style="margin-bottom: 40px; padding: 40px; z-index: -1; margin-left: 300px;">
        ...
        <nav id="breadcrumbs" class="dark">
            <ul style="border-radius: 10px;">
                ...
                <li class="auto-style1">Current plan</li>
            </ul>
        </nav>
    </div>
    ...
    <%-- ai images box part --%>  
        ...
        <div class="dashboard-box margin-top-0 margin-bottom-30">
                    <!-- Headline -->
                    <div class="headline">
                        <h3> <i class="fa-solid fa-gift"></i>Current plan</h3>
                    </div>
                    <div class="content with-padding">
                        <table class="basic-table">
                            <thead>
                            <tr>
                                <th data-priority="1">Membership</th>
                                <th>payment Mode</th>
                                <th class="small-width">StartDate</th>
                                <th data-priority="2" class="small-width">ExpiryDate</th>
                            </tr>
                            </thead>
                            <tr>
                                <td>Free Plan</td>
                            ...
                            <tr>
                                        <td align="right" colspan="7"><button type="button" class="button" onclick="window.location.href='#'">Change Plan</button></td>
                                    </tr>
                        </table>
                     </div>
                </div>
