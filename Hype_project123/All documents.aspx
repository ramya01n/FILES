<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="All documents.aspx.cs" Inherits="Hype_project123.All_documents" %>
        ...
        <nav id="breadcrumbs" class="dark">
            <ul style="border-radius: 10px;">
                <li><a href="homepage.aspx" style="color: white; text-decoration:none;">Home</a></li>
                 <li><a href="#" style="color: white; text-decoration:none;">All Documents</a></li>
            </ul>
        </nav>
    </div>
    ...
    <div class="dashboard-box margin-top-0 margin-bottom-30">
        ...
        <div class="content with-padding">
            <table class="basic-table">
                <thead>
                    <tr>
                        <th data-priority="1">Documents</th>
                        <th>Contents</th>
