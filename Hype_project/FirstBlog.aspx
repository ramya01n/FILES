<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="FirstBlog.aspx.cs" Inherits="Hype_project.FirstBlog" %>
...
*, *::before, *::after {
        ...
        <div class="row">
            ...
            <div class="col-xl-8 col-lg-8">
                    ...
                    <div class="blog-post-content">
                        ...
                        <div id="respond" class="blog-widget">
                            ...
                            <div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                      <p>You are commenting as: <strong>RamyaNswamy</strong></p>
                                        </div>
                                    <div class="col-md-12">
             ...
             <div class="auto-style12"style="margin-left:1000px;margin-top:-1800px;">
                        <h3>Recent Blog
                           <input class="auto-style15" type="text" placeholder="Search..." name="s0" id="search-widget0"style="margin-right:500px;"></h3> 
                  <!-- Blog Post -->
                    <a href="#" class="blog-post"style="margin-left:-300px;width:40%;height:19%;">
                        <!-- Blog Post Thumbnail -->
                        <div class="blog-post-thumbnail">
                            <div class="blog-post-thumbnail-inner">
    ...
    <div class="testimonials"style="margin-left:700px;margin-top:-1300px;">
