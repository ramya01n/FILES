...
<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="HomePage.aspx.cs" Inherits="Hype_project.HomePage" %>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
       <!-- Brain logo -->

               <br> 
                <p style="text-align:center;"><img style="width:199px" src="images/brainsimage.png"  / alt="image" alt="Logo"></p> <br/>
...
@keyframes animatedBackground_b{
   ...
   <section>
         <center>
               ...
               <a href="https://localhost:44362/Registration.aspx" class="btn btn-primary" style="background-color:#184698;border-radius: -1px;box-shadow:0 4px 12px;color: #fff">Get Started for Free →</a>
               </div>
         </center>
    
        <center>
               <p style="width: 292px">
                 <h7>   <span class="auto-style16">No credit card required.  </span>  <h7>
              </p>
        <center>
   </section>
    ...
    <section style="margin-top:90px;">       
        <div class="container"style="margin-left:559px;">
            <div class="row">
                <div class="col-12">
                    <center>
                        <h2>How it Works?</h2>
          ...
          <div class="container">
              <div class="row" style="display:flex">
                <div class="col-md-4">
                    <center>
                       <img width="120px" src="images/selecttemplateimage.png"/>
                ...
                <div class="col-md-4">
                        <center>                           
                                <img width="170px" src="images/filltheformimage.png" style="height: 132px; margin-top: 5px" />
                                <h2>Fill the form</h2>
                                <p class="text-justify">
                    ...
                    <div class="col-md-4">
                        <center>
                                ...
                                <img width="150px" src="images/getyourcontentimage.png" />
    ...
    <div class="section padding-top-65 padding-bottom-65">
        <div class="container margin-bottom-20">
            <div class="section-headline centered margin-top-0 margin-bottom-30">
                ...
                <p style="color: #808080">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Generate your required content with over 60+ content creation templates</p>
            </div>
            <div class="template-categories home-templates">
                <ul>
                    <li class="active"><a href="javascript:void();" class="ai-templates-category" data-category="all">All templates</a></li>
                                  ...
                                  <div class="row ai-template-blocks"style="width:80%;margin-left:66px;">
                            ...
                            <div class="col-xl-4">
                                <a href="#" class="blog-compact-item-container">
                                    <div class="auto-style10">                                     
                                       <img src="images/gallery.png" style="height: 327px; width: 366px" />                                  
