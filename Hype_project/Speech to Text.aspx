<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Speech to Text.aspx.cs" Inherits="Hype_project.Speech_to_Text" %>
...
<body>
        ...
        <div>
             <div class="topbar">
                    <div class="logo">
                        <center> <img src="image/hype%20image.png" /></center>
                    </div>
                                            ...
                                            <div class="user-avatar status-online">
                                                <div class="dropdown">
                                                    <span onclick="myFunction1()" class="dropbtn1" >
                                                        <img src="image/contact%20icon%20image.png" />
                                                    </span>
                                                </div>
                                            </div>
                                        </a>
        ...
        <div class="col-md-4"style="">
            <div class="dashboard-box margin-top-0 margin-bottom-30"style="margin-left:300px">
                ...
                <div class="content with-padding">
                    ...
                    <div class="col-md-8">
                        <div class="dashboard-box margin-top-0 margin-bottom-30"style="margin-left:649px;margin-top:-909px;width:initial">
                            <!-- Headline -->
                           <div class="headline">
