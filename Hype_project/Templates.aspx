<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Templates.aspx.cs" Inherits="Hype_project.Templates" %>
       ...
       <div class="topbar">
          ...
          <div class="header-notifications user-menu">
              ...
              <div class="sidebar" style="font-size:15px">
                        ...
                        <span onclick="myFunction()" class="dropbtn" style="font-size:13px;">My Documents</span>
                          <div id="myDropdown1" class="dropdown-content" >
                                   ...
                                   <a href="https://localhost:44362/AI%20images.aspx">All AI Images</a>
                              </div>
                              </div>
                              </a>
                           </li>                          
                         ...
                         <ul>
                            ...
                            <li>
                             ...
                             <li>
                              <a href="https://localhost:44362/AI%20images.aspx">
                            ...
                            <li>
                             ...
                             <ul>
                                 <li>
                                 <div style="color:darkblue;font-weight:600; margin-top:50px">
                                    <h9>  Account</h9>
                                 </div>
                             </li>
                              <li>
              ...
              <div class="dashboard-headline"style="margin-top:100px;margin-bottom:40px;padding:40px;width:50%;">
                    <h3 class="auto-style1"style="margin-right:1000px;margin-left:300px;">
                              Templates
                        <div class="word-used-wrapper margin-left-10"style="margin-left:-400px;">
                    ...
                    <nav id="breadcrumbs" class="dark"style="margin-right: 30px;margin-top: -155px;">
                        <ul>
                            <li><a href="#" style="color:grey;"><span class="auto-style9">Home</span></a></li>
                            <li class="auto-style9">Templates</li>
                        </ul>
                    </nav>
                </div>
              <div>
            <input id="template-search" placeholder="Search..." type="text" class="auto-style2"style="border-radius:30px; width: 65%;
    margin-left: 302px;"/>
        </div>
     ...
     <div class="section padding-top-65 padding-bottom-65">
        <div class="container margin-bottom-20">
            ...
            <div class="template-categories home-templates"style="margin-left:300px;">
                <ul>
                    <li class="active"><a href="javascript:void();" class="ai-templates-category" data-category="all"><span class="auto-style3">All templates</span></a></li>
                                            <li><a href="javascript:void();" class="ai-templates-category" data-category="1"><span class="auto-style4">Article And Blogs</span></a></li>
