<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AI images.aspx.cs" Inherits="Hype_project.AI_images" %>
        ...
        <%-- ai images used --%>
         <div class="dashboard-headline"style="margin-bottom:40px;padding:40px;margin-left:300px;">
                    ...
                    <nav id="breadcrumbs" class="dark">
                        <ul style="border-radius:10px;margin-radius:10px;">
              ...
              <div id="ai_images" name="ai_images" method="post" action="#"style="margin-left:300px;">
                   ...
                   <button type="submit" name="submit" class="button ripple-effect border-pilled" style="background-color:darkblue;color:white; border-radius:20px;" onclick="myFunction3()">Generate<i class="fa fa-arrow-right" aria-hidden="true"></i>
                    ...
                    <div id="main" style="display:none">
                      ...
                      <br />
                    <small><button onclick="hideshow()" style="padding:5px 5px;margin-left: 263px;border:none;color:darkblue">Advanced Settings</button> <strong>+</strong></small><hr/>
