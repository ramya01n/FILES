<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dashboard.aspx.cs" Inherits="Hype_project.Dashboard" %>
...
<body>
    <header>
                   ...
                   <i class="fa fa-bars" id="icon" style="margin-top: -4px;"></i>
                    ...
                    <div class="selectlang">
                          ...
                          <div id="login" class="dropdown-content" >
                                           ...
                                           <a href="#"><i class="fa fa-th-large"></i>Dashboard</a>
     ...
     <div>         
     <h3><img width="20px"src="images/words%20used%20this%20month.png" />Words used this Month</h3>
